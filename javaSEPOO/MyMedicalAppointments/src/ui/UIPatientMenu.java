...
public class UIPatientMenu {
    public static void showPatientMenu() {
        ...
        do {
            ...
            System.out.println("1. Bool an appointment");
    ...
    private static void showBookAppointmentMenu() {
        ...
        do {
            ...
            for (int i = 0; i < UIDoctorMenu.doctorsAvailableAppointments.size(); i++) {
                ArrayList<Doctor.AvaibleAppointment> avaibleAppointments = UIDoctorMenu.doctorsAvailableAppointments
                        .get(i).getAvaibleAppointments();
            ...
            System.out.println(doctorSelected.getName() + ". Date: "
                    + doctorSelected.getAvaibleAppointments().get(indexDate).getDate() + ". Time: "
    ...
    private static void showPatientMyAppOintments() {
        int response = 0;
        do {
            System.out.println("::My Appointmebts");
